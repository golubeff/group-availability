...
export function AvailabilityCalendar({
  ...
  useEffect(() => {
    ...
    return () => window.removeEventListener("mouseup", stopDragPaint);
  }, [stopDragPaint]);
            ...
            {weeks.flat().map((cell, i) => {
              ...
              return (
                <div
                  ...
                  className={cn(
                    "relative aspect-square flex items-center justify-center rounded text-[11px] font-medium select-none cursor-pointer min-h-[32px] transition-colors active:scale-90",
                    cellBg[myStatus],
